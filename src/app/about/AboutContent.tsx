...
export default function AboutContent({ isOpenToWork }: AboutContentProps) {
  useEffect(() => {
          ...
          <div className={styles.content}>
            <AnimatedSection delay={200}>
              <p className={styles.intro}>
                A seasoned engineering leader delivering performant, scalable,
                and user-centric digital platforms across enterprise
                environments. Drives architecture design and modernisation for
                high-traffic web ecosystems with a strong focus on SEO,
                accessibility, and modular design. Collaborates
                cross-functionally with business, product, and design teams to
                ensure alignment between technology execution and strategic
                goals. Trusted for mentoring engineering teams and uplifting
            ...
            <AnimatedSection delay={300}>
              <div className={styles.openToWorkSection}>
                <div className={styles.openToWorkContent}>
                  ...
                  <p className={styles.openToWorkMessage}>
