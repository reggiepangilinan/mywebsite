...
- **Blog Posts** (`/blog/[slug]`): 86400 seconds (24 hours) - On-demand ISR
...
export const ISR_CONFIG = {
  BLOG_POST_REVALIDATE: 86400, // 24 hours - Individual blog posts (cost-optimized)
...
```typescript
export const revalidate = 86400 // Update to match BLOG_POST_REVALIDATE (24 hours)
```
